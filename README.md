...
[![Version](https://img.shields.io/badge/version-0.9.2-orange.svg)](https://github.com/ovitrac/CloakMCP/releases)
...
├── pyproject.toml                 # Package metadata (v0.9.2)
...
**Latest**: v0.9.2 — TOCTOU race fix in session cleanup (v0.9.1: stale session auto-recovery, v0.9.0: G1-G5)
